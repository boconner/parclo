...
async function main() {
  ...
  // Branding is deliberately NOT seeded. It is set in Configuration → Branding
  // and must survive a re-seed; an earlier version wrote a fictional brand here
  // and would silently overwrite anything still on the default name.

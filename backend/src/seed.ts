...
async function main() {
  ...
  await prisma.store.createMany({
    data: [
      { id:'1',  name:'Vine Valley - Uptown',         area:'Uptown',           marketSlug:'dallas',      chainId:'vine-valley',  repId:'r1',  latitude:32.796, longitude:-96.801,  onShelf:4,  inProcess:12, daysOfSupply:3,  depletionRate:1.3, lastVisit:new Date('2026-04-22T14:00:00Z') },
      { id:'2',  name:"City Cellars - Oak Lawn",             area:'Oak Lawn',         marketSlug:'dallas',      chainId:'city-cellars',        repId:'r2',  latitude:32.810, longitude:-96.815,  onShelf:8,  inProcess:0,  daysOfSupply:6,  depletionRate:1.1, lastVisit:new Date('2026-04-21T10:00:00Z') },
      { id:'3',  name:"Harbor Spirits - Deep Ellum",          area:'Deep Ellum',       marketSlug:'dallas',      chainId:'harbor-spirits',       repId:'r1',  latitude:32.783, longitude:-96.778,  onShelf:22, inProcess:24, daysOfSupply:18, depletionRate:1.2, lastVisit:new Date('2026-04-20T09:00:00Z') },
      { id:'4',  name:'Vine Valley - Bishop Arts',     area:'Bishop Arts',      marketSlug:'dallas',      chainId:'vine-valley',  repId:'r3',  latitude:32.746, longitude:-96.832,  onShelf:18, inProcess:0,  daysOfSupply:15, depletionRate:1.0, lastVisit:new Date('2026-04-17T11:00:00Z') },
      { id:'5',  name:'Bottle Barn - Lower Greenville', area:'Lower Greenville', marketSlug:'dallas',      chainId:'bottle-barn',   repId:'r2',  latitude:32.823, longitude:-96.775,  onShelf:5,  inProcess:12, daysOfSupply:4,  depletionRate:1.4, lastVisit:new Date('2026-04-22T13:00:00Z') },
      { id:'6',  name:"City Cellars - Knox-Henderson",       area:'Knox-Henderson',   marketSlug:'dallas',      chainId:'city-cellars',        repId:'r3',  latitude:32.828, longitude:-96.791,  onShelf:31, inProcess:0,  daysOfSupply:28, depletionRate:0.9, lastVisit:new Date('2026-04-21T08:00:00Z') },
      { id:'7',  name:"City Cellars - Montrose",             area:'Montrose',         marketSlug:'houston',     chainId:'city-cellars',        repId:'r4',  latitude:29.741, longitude:-95.390,  onShelf:6,  inProcess:0,  daysOfSupply:5,  depletionRate:1.1, lastVisit:new Date('2026-04-19T15:00:00Z') },
      { id:'8',  name:'Bottle Barn - The Heights',      area:'The Heights',      marketSlug:'houston',     chainId:'bottle-barn',   repId:'r5',  latitude:29.790, longitude:-95.398,  onShelf:24, inProcess:12, daysOfSupply:20, depletionRate:1.0, lastVisit:new Date('2026-04-22T09:00:00Z') },
      { id:'9',  name:'Vine Valley - River Oaks',      area:'River Oaks',       marketSlug:'houston',     chainId:'vine-valley',  repId:'r4',  latitude:29.739, longitude:-95.431,  onShelf:11, inProcess:0,  daysOfSupply:9,  depletionRate:1.0, lastVisit:new Date('2026-04-21T10:00:00Z') },
      { id:'10', name:'Copper Cork - South Congress',  area:'South Congress',   marketSlug:'austin',      chainId:'copper-cork', repId:'r6',  latitude:30.246, longitude:-97.750,  onShelf:28, inProcess:0,  daysOfSupply:23, depletionRate:1.1, lastVisit:new Date('2026-04-22T10:00:00Z') },
      { id:'11', name:'Copper Cork - East 6th',        area:'East 6th',         marketSlug:'austin',      chainId:'copper-cork', repId:'r6',  latitude:30.261, longitude:-97.723,  onShelf:7,  inProcess:0,  daysOfSupply:6,  depletionRate:1.0, lastVisit:new Date('2026-04-19T11:00:00Z') },
      { id:'12', name:"City Cellars - Pearl District",        area:'Pearl District',   marketSlug:'san-antonio', chainId:'city-cellars',        repId:'r7',  latitude:29.438, longitude:-98.469,  onShelf:16, inProcess:0,  daysOfSupply:14, depletionRate:1.0, lastVisit:new Date('2026-04-21T09:00:00Z') },
      { id:'13', name:'Bottle Barn - Alamo Heights',     area:'Alamo Heights',    marketSlug:'san-antonio', chainId:'bottle-barn',   repId:'r7',  latitude:29.487, longitude:-98.461,  onShelf:5,  inProcess:12, daysOfSupply:4,  depletionRate:1.3, lastVisit:new Date('2026-04-17T14:00:00Z') },
      { id:'14', name:'Vine Valley - Tyler',            area:'Tyler',            marketSlug:'east-texas',  chainId:'vine-valley',  repId:'r8',  latitude:32.351, longitude:-95.301,  onShelf:18, inProcess:0,  daysOfSupply:15, depletionRate:1.0, lastVisit:new Date('2026-04-22T08:00:00Z') },
      { id:'15', name:'Bottle Barn - El Paso',           area:'Downtown EP',      marketSlug:'el-paso',     chainId:'bottle-barn',   repId:'r9',  latitude:31.758, longitude:-106.487, onShelf:20, inProcess:0,  daysOfSupply:18, depletionRate:1.0, lastVisit:new Date('2026-04-21T09:00:00Z') },
      { id:'16', name:"City Cellars - Corpus Christi",        area:'Downtown CC',      marketSlug:'corpus',      chainId:'city-cellars',        repId:'r10', latitude:27.800, longitude:-97.396,  onShelf:14, inProcess:0,  daysOfSupply:12, depletionRate:1.0, lastVisit:new Date('2026-04-20T10:00:00Z') },
      { id:'17', name:"City Cellars - Brownsville",           area:'Downtown BV',      marketSlug:'brownsville', chainId:'city-cellars',        repId:'r11', latitude:25.902, longitude:-97.497,  onShelf:17, inProcess:0,  daysOfSupply:14, depletionRate:1.0, lastVisit:new Date('2026-04-22T08:00:00Z') },
      { id:'18', name:'Bottle Barn - Laredo',            area:'Downtown LR',      marketSlug:'laredo',      chainId:'bottle-barn',   repId:'r12', latitude:27.506, longitude:-99.507,  onShelf:22, inProcess:12, daysOfSupply:19, depletionRate:1.0, lastVisit:new Date('2026-04-21T09:00:00Z') },
    ],
    skipDuplicates: true,
  })
